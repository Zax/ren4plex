...
var ren4plex = {
    ...
    config : {
        ...
        ignoreWords : [
            '','480p','720p','1080p',
            'ITA','ENG','Subs','Sub','iTALiAN','jap','ENGLiSH','Fansub','Softsub','0sec',
            ...
            'AC3','Mp3','aac','2CH','DTS','Dts','2HD','HD','Webmux',
            // releaser
    ...
    getFilename: function (filename){
        ...
        for (i = words.length - 1; i >= 0; i--) {
            ...
            // skip title (words after episode)
            if (this.config.removeTitle && this.config.parseEpisode && episode === '') continue;
    ...
    start: function(path, cb){
        ...
        + (ren4plex.config.removeTitle ? colors.green('[REMOTE TITLE]') : '')
        };
...
ren4plex.config.removeTitle = program.remoteTitle;
