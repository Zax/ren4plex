...
var ren4plex = {
    ...
    config : {
        ...
        ignoreWords : [
            ...
            'AC3','Mp3','aac','2CH','DTS','Dts','2HD','HD',
            // releaser
            'TrTd_Team','HEVC','kh','iGM','GiuseppeTnT','Marco','lol','SToNeD','AlgernonWood','NovaRip','Pir8','KILLERS','ZMachine','byR02','DarkSideMux','TeRRa',
            'FoV','IGM','SATOSHi','TLA','RiVER','oRo','by','IperB','rarbg','xXTenGXx','ASAP','TRL','NAHOM','BLUWORLD','Kagome','VTV','Shiv@','QCF','Blackbit', 'Maxks', 'Ruskiyspetz','iCV','T4P3','Batv'
        ]
    },
