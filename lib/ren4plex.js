...
var ren4plex = {
    ...
    printFileName: function (oldFile, newFile){
        if (oldFile === newFile)
            console.log(colors.grey(' - ') + colors.grey(oldFile));
        else
            console.log(colors.grey(' - ') + colors.white(oldFile) + colors.grey(' -> ') + colors.white(newFile));
    },
        ...
        fs.readdir(path, function(err, files){
            ...
            files.forEach(function(file){
                ...
                if (ren4plex.config.preview){
                    ren4plex.printFileName(file, newName);
                    return;
                }
    ...
    start: function(path){
        console.log(colors.white('rename files on ')
            + colors.yellow(path) + ' '
